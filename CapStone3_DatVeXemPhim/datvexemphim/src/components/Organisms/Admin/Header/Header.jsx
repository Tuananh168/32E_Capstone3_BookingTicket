...
const Header = () => {
  ...
  return (
    <Container className="container mx-auto Login">
      <div className="container flex justify-between mx-auto h-20 items-center border-2 bg-slate-900">
        <div className="w-1/6 border-r-2 text-xl font-medium text-white h-full flex items-center justify-center">
          <img
        ...
        <div className="w-5/6">
          {login === false ? (
            ...
            <div className="LoginUser pr-12">
              Xin chào
              <span className="ml-3 text-lg text-orange-700">
                {userLogin.taiKhoan}
              </span>
              <button
      ...
      <div className="flex border-2 border-t-0 h-screen">
        <div className="w-1/6 flex flex-col border-r-2 bg-slate-900">
          <NavLink to="user">
            <button
              className="text-lg font-medium mt-8 mb-4 py-2 w-full text-white hover:underline"
          ...
          <NavLink to="film">
            <button className="text-lg font-medium py-2 w-full  text-white hover:underline">
              Quản lý phim
            </button>
          </NavLink>
        </div>
